...
def plot_XPT(X : torch.Tensor, P : torch.Tensor, T : torch.Tensor, dim : int
    ...
    plt.figure()
    plt.title('Mu')
    plt.imshow(X[:dim].cpu().detach().numpy().reshape(int, int), cmap='magma')
    plt.colorbar()
    plt.show()
    plt.figure()
    plt.title('Nu')
    ...
    plt.figure()
    plt.title('T')
    plt.imshow(T.cpu().detach().numpy().reshape(int, int), cmap='magma')
    plt.colorbar()
    plt.show()
    plt.figure()
    plt.title('P')
    plt.imshow(P.cpu().detach().numpy().reshape(int, int), cmap='magma')
    plt.colorbar()
    plt.show()
